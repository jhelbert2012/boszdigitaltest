...
@Component(immediate=true, label="Archive pages")
@Properties({
	@Property(name=Constants.SERVICE_DESCRIPTION, value="Archive pages"),
	@Property(name=Constants.SERVICE_VENDOR, value="Boszdigital"),
	@Property(name="process.label", value="Archive pages")
})
@Service

public class ArchivePages implements WorkflowProcess {
